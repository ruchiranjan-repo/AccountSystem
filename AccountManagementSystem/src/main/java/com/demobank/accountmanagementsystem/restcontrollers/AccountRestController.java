...
import com.demobank.accountmanagementsystem.dto.ExceptionDto;
...
/*
	...
	public ResponseEntity<Object> accountNumberNotFoundExceptionHandler(AccountNumberNotFoundException accountNumberNotFoundException) {
		...
		message.setMessages(accountNumberNotFoundException.getMessage());
		message.setErrorCode(accountNumberNotFoundException.getErrorCode());
